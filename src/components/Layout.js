...
export default function Layout({ children }) {
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900 animate-fadeIn">
      <Navbar />
      <main className="flex-1">{children}</main>
      <footer className="bg-gradient-to-br from-indigo-900 to-indigo-950 text-white mt-1">
        <div className="max-w-7xl mx-auto px-4 py-16 grid md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-indigo-200">
              ...
              <li>
                <Link href="/benefits" className="hover:text-white flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                  </svg>
                  Výhody pro řidiče
          ...
          <div>
            ...
            <ul className="space-y-3 text-indigo-200">
              ...
              <li>
                <Link href="/uber" className="hover:text-white flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                  </svg>
                  Jezdit s Uberem
