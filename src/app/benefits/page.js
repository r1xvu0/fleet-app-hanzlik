      ...
      <>
        ...
        <section className="bg-indigo-900 text-white py-32 px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl">Proč se řidiči vracejí a doporučují nás dalším</p>
          </div>
        </section>
        ...
        <section className="py-20 px-4 bg-white">
          <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="p-8 border rounded-xl hover:border-indigo-200 transition-colors">
        ...
        <section className="bg-indigo-50 py-20 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-12 text-center">Proč zvolit nás?</h2>
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {[
                    { feature: 'Provize z jízdného', us: '10-15%', others: '20-30%' },
                    { feature: 'Dostupná podpora', us: '24/7', others: 'Jen v pracovní dny' },
                    { feature: 'Pojištění vozidla', us: 'V ceně', others: 'Vlastní' },
        ...
        <section className="bg-white py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mb-8 text-lg text-gray-600">Začněte vydělávat již zítra</p>
