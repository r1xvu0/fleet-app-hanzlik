          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-gray-600">
                Začínali jsme s 5 vozy v centru Prahy. Dnes máme přes 300 vozů 
                a 1000 spokojených řidičů po celé ČR. Naše vize zůstává stejná - 
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="p-6 border rounded-xl hover:border-indigo-200 transition-colors">
